...
async def fetch_jwks(
    ...
    Args:
        client_session: The aiohttp client session for making requests.
        oauth_metadata: The OAuth metadata containing the JWKS URI.
...
def validate_jwt_token(
    ...
    Args:
        ...
        jkws_uri: The JWKS URI to fetch signing keys from.
        signing_algos: List of supported signing algorithms.
