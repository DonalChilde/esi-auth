...
class EsiAuthSettings(BaseSettings):
    ...
    app_credentials_dir: Path = Field(
        default=DEFAULT_APP_DIR / "credentials",
        description="Directory for application credential JSON files.",
    )
    tokens_dir: Path = Field(
        default=DEFAULT_APP_DIR / "tokens",
        description="Directory for ESI token JSON files.",
    )
...
def get_settings() -> EsiAuthSettings:
    ...
    settings.app_credentials_dir.mkdir(parents=True, exist_ok=True)
